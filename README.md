...
Бот автоматизирует управление Discord-семьёй: отображает состав, обрабатывает заявки, ведёт статистику и помогает с модерацией.
...
| 🛡️ **Автомодерация** | Анти-спам, анти-мат, анти-инвайты, капс-LOCKS |
...
| Модуль | Описание |
|--------|----------|
| 🔴 **Анти-Спам** | Ограничение количества сообщений |
| 🔴 **Анти-Мат** | Фильтрация нецензурных слов |
| 🔴 **Анти-Инвайты** | Запрет сторонних инвайт-ссылок |
| 🔴 **Анти-Эмодзи** | Ограничение количества эмодзи |
| 🔴 **Анти-Пинги** | Ограничение упоминаний |
| 🔴 **Анти-Картинки** | Ограничение вложений |
| 🔴 **Caps Lock** | Фильтр капса |
